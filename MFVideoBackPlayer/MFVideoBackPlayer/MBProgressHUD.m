...
+ (instancetype) sharedInstance {
    ...
    dispatch_once(&onceToken, ^{
        sharedHUD = [[MBProgressHUD alloc] initWithFrame: CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, 100)];
        sharedHUD.removeFromSuperViewOnHide = YES;
        sharedHUD.margin = 15;
        [[UIApplication sharedApplication].windows[0] addSubview: sharedHUD];
    });
...
- (void)layoutSubviews {
    ...
    labelSize = getHeightLabel.frame.size;
